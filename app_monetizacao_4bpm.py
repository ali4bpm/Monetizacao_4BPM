...
# Salve o código do app aqui conforme solicitado
# app_monetizacao_4bpm.py
...
EXCEL_POSSIBLE_PATHS = [
    ...
    "Monetizacao_4BPM.xlsx",
    "Tabela_Monetizacao_PM_RN.xlsx",
]
...
if df_filt.empty:
    ...
    with c1:
        st.metric("Total Monetizado (R$)", f"R$ {total_valor:,.2f}", delta=f"{delta_label if 'delta_label' in locals() else ''}", delta_color="normal")
    with c2:
